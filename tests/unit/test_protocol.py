...
class TestTelexMessageValidation:
    ...
    def test_malformed_json_syntax_error(self):
        ...
        malformed_json = '{"routing": {"source": "1234", "destination": "5678"}'  # Missing closing brace
...
class TestAsyncTCPNetworkAdapter:
    ...
    async def test_accepts_multiple_concurrent_connections(self):
        ...
        try:
            ...
            await asyncio.gather(
                send_message(18024, 1),
                send_message(18024, 2),
                send_message(18024, 3)
            )
    ...
    async def test_uses_readline_for_framing(self):
        ...
        try:
            ...
            msg1 = {"routing": {"source": "1111", "destination": "2222"}, "content": {"body": "Msg1"}}
            msg2 = {"routing": {"source": "3333", "destination": "4444"}, "content": {"body": "Msg2"}}
